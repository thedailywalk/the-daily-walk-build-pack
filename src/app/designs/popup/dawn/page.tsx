    ...
    <div className="dw-frame">
      ...
      <div className="dw-card" style={{ "--crestAccent": t.crestAccent } as React.CSSProperties}>
        ...
        <div className="dw-body">
          ...
          <p className="dw-sub">You&apos;ll never grow close to someone you never actually talk to — not even God. This is where the conversation starts: ten honest minutes in His Word each morning that quietly change the other twenty-three hours. Ephesians calls it putting on your armor — so start your day already armed. Free, forever.</p>
