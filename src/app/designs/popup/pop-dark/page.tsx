...
.pv-dark .pv-card { position:relative; width:100%; max-width:520px; max-height:calc(100vh - 48px); overflow:auto; border-radius:22px; padding:30px 28px 26px; background:linear-gradient(165deg,#0e1626 0%,#16263f 100%); border:1px solid var(--line); box-shadow:0 30px 80px rgba(0,0,0,.6),0 0 0 1px rgba(255,255,255,.03) inset, 0 0 40px rgba(227,192,116,.06); animation:pv-pop .5s cubic-bezier(.16,1,.3,1) both; }
